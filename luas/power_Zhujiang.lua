--	珠江-CU3000C-CSCPV106通信协议(V1.0)－20150717.doc
			...
			parse =
				{
					...
					{"SL", "NU", "lg_rcCount"},
						{"BYTE", "U16", 6113001, "rs * 0.1"},
						{"SET", "U8", "lg_usrCount = rs"},
						{"SL", "NU", "lg_usrCount"},
							{"BYTE", "U16", 6114001, "rs * 0.01"},
						{"EL"},
					{"EL"},
				},
			delay = 500,
			...
			parse =
				{
					...
					{"BYTE", "U16", 6112001, "rs * 0.1"},
					{"BYTE", "U8", 6126001},
					{"SL", "P1"},
						{"BYTE", "U16", 6115001, "rs * 0.1"},
					{"EL"},
					{"BYTE", "J2"},
					{"BYTE", "U16", 6125001, "rs * 0.01"},
					{"BYTE", "J4"},
				},
			delay = 500,
			needLen = 33,
