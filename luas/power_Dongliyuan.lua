...
local rs = 
	{
			...
			parse =
				{
					...
					{"SL", "NU", "lg_rcCount"},
						...
						{"SET", "U8", "lg_usrCount = rs"},
						{"BYTE", "J2"},
						{"BYTE", "U8", 6025001, "rs == 1"},
						{"BYTE", "U8", 6027001, "rs == 1"},
						{"BYTE", "J1"},
						{"BYTE", "U8", 6028001, "rs == 0xE2"},
						{"SL", "NU", "lg_usrCount - 1"},
							{"BYTE", "J1"},
						{"EL"},
					{"EL"},
		...
		--step6, dc_ai
		{
			pack = l_gb.pack({0xFF}, g_ver, g_adr, 0x42, 0x42),
			parse =
				{
					{"BYTE", "J7"},
					{"SET", "U8", "lg_dcCount = rs"},
					{"SL", "NU", "lg_dcCount"},
						{"BYTE", "U16", 6111001, "rs * 0.01"},
						{"BYTE", "U16", 6112001, "rs * 0.01"},
						{"BYTE", "U8", 6126001},
						{"SL", "P1"},
							{"BYTE", "U16", 6115001, "rs * 0.01"},
						{"EL"},
						...
						{"EL"},
						{"BYTE", "J1"},
						{"SET", "U16", "lg_usrCount = rs"},
						{"SL", "NU", "lg_usrCount"},
							{"BYTE", "J2"},
						{"EL"},
						{"SET", "U16", "lg_usrCount = rs"},
						{"SL", "NU", "lg_usrCount"},
							{"BYTE", "U16", 6125001, "rs * 0.01", "21930"},
						{"EL"},
						{"BYTE", "JN"},
					{"EL"},
				},
		...
		--step7, dc_alarm
		{
			pack = l_gb.pack({0xFF}, g_ver, g_adr, 0x42, 0x44),
			parse =
				{
					{"BYTE", "J7"},
					{"SET", "U8", "lg_dcCount = rs"},
...
function getEqualizingChargeCmd(value)
	{
