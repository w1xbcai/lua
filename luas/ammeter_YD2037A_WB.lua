...
local rs = 
	{
		-- step1,
		{
			pack = l_md.pack({0x03, 0x00, 0x00, 0x0A}, g_adr, 0x03),
			parse = 
				{
					{"BYTE", "J14"},
					{"SET", "U16", "lg_pt = rs"},
					{"BYTE", "NU", 16125001, "lg_pt"},
					{"BYTE", "J2"},
					{"SET", "U16", "lg_ct = rs"},
					{"BYTE", "NU", 16124001, "lg_ct"},
				},
			delay = 500,
			needLen = 25,
		},
		{
			pack = l_md.pack({0x00,0x00,0x00,0x29}, g_adr, 0x03),
			parse = 
				{	
					{"BYTE", "U16", 16104001, "rs * 0.1 * lg_pt"},
					{"BYTE", "U16", 16101001, "rs * 0.1 * lg_pt"},
					{"BYTE", "U16", 16107001, "rs * 0.001 * lg_ct"},
					{"BYTE", "J2"},
					{"BYTE", "I16", 16111001, "rs * 0.001 * lg_ct * lg_pt"},
					--{"BYTE", "I16", 16117001, "rs * 0.0001"},
					{"BYTE", "J2"},
				
					{"BYTE", "I16", 16114001, "rs * 0.001 * lg_ct * lg_pt"},
					{"BYTE", "J2"},
					
					{"BYTE", "U16", 16105001, "rs * 0.1 * lg_pt"},
					{"BYTE", "U16", 16102001, "rs * 0.1 * lg_pt"},
					{"BYTE", "U16", 16108001, "rs * 0.001 * lg_ct"},
					{"BYTE", "J2"},
					{"BYTE", "I16", 16112001, "rs * 0.001 * lg_ct * lg_pt"},
					--{"BYTE", "I16", 16117002, "rs * 0.0001"},
					{"BYTE", "J2"},
					{"BYTE", "I16", 16115001, "rs * 0.001 * lg_ct * lg_pt"},
					{"BYTE", "J2"},
					
					{"BYTE", "U16", 16106001, "rs * 0.1 * lg_pt"},
					{"BYTE", "U16", 16103001, "rs * 0.1 * lg_pt"},
					{"BYTE", "U16", 16109001, "rs * 0.001 * lg_ct"},
					{"BYTE", "J2"},
					{"BYTE", "I16", 16113001, "rs * 0.001 * lg_ct * lg_pt"},
					-- {"BYTE", "I16", 16117003, "rs * 0.0001"},
					{"BYTE", "J2"},
					{"BYTE", "I16", 16116001, "rs * 0.001 * lg_ct * lg_pt"},
					{"BYTE", "J8"},					
					
					{"BYTE", "U16", 16118001, "rs * 0.001"},--频率
					{"BYTE", "J2"},

					{"BYTE", "I16", 16117001, "rs * 0.0001"},--功率因数 53

					{"BYTE", "J6"},
					
					{"SET", "U16", "lg_zheng_wh_h = rs"},
					{"BYTE", "U16", 16122001, "((rs << 16) | lg_zheng_wh_h) * lg_ct * lg_pt*0.001"},
					{"BYTE", "J4"},

					{"SET", "U16", "lg_fan_wh_h = rs "},
					{"BYTE", "U16", 16123001, "((rs << 16) | lg_fan_wh_h) * lg_ct * lg_pt*0.001"},
					{"BYTE", "J4"},
