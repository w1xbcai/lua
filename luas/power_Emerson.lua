...
local rs = 
	{
		...
		-- step2, ac_ai
		{
			pack = l_gb.pack({0}, g_ver, g_adr, 0x40, 0x41),
			parse = 
				{
					{"BYTE", "J7"},
		...
		--step3, ac_alarm
		{
			pack = l_gb.pack({0}, g_ver, g_adr, 0x40, 0x44),
			parse = 
				{
					{"BYTE", "J12"},
		...
		--step6, dc_ai
		{
			pack = l_gb.pack(nil, g_ver, g_adr, 0x42, 0x41),
			parse =
				{
					{"BYTE", "J7"},
			...
			parse =
				{
					...
					{"SL", "NU", "lg_dcCount"},
						...
						{"BYTE", "J2"},
						{"SL", "NU", "2"},
							{"BYTE", "U8", 6002001, "rs ~= 0"},
						{"EL"},
						{"BYTE", "J2"},
						{"BYTE", "U8", 6030001, "rs ~= 0"},
						{"BYTE", "U8", 6031001, "rs ~= 0"},
						{"BYTE", "J77"},
					{"EL"},
				},
			delay = 500,
