...
local rs = 
	{
		-- step1,机组运行状态
		{
			pack = l_md.pack({0x00, 0x00, 0x00, 0x01}, g_adr, 0x01),
			parse = 
				{
					{"BYTE", "U16", 25004001},
		...
		-- step2,
		{
			pack = l_md.pack({0x00, 0x00, 0x00, 0x0B}, g_adr, 0x02),
			parse = 
				{
		...
		-- step3,
		{--00 E2 00 FA 00 00 00 00 00 00 00 00 00 37
			pack = l_md.pack({0x00,0x00,0x00,0x07}, g_adr, 0x03),
			parse = 
				{	
					{"BYTE", "U16", 25101001, "(rs-180)*0.5"},
					{"BYTE", "U16", 25103001, "(rs-180)*0.5"},
					{"BYTE", "J8"},
					{"BYTE", "U16", 25102001, "rs-5"},
